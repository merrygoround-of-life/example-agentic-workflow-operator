...
import (
	...
	"github.com/merrygoround-of-life/agentic-workflow-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "f6b9d12f.plantrue.com",
	...
	if err := (&controller.AgenticWorkflowReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "AgenticWorkflow")
		os.Exit(1)
	}
